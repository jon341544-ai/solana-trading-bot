...
def trading_loop():
    ...
    while trading_state.is_running:
        try:
            ...
            print(f"FantailVMA: {'🟢 LONG' if signals['fantail_vma'] == 1 else '🔴 SHORT' if signals['fantail_vma'] == -1 else '⚪ NEUTRAL'}")
            ...
            if signals['consensus'] == 'BUY' and trading_state.last_position != 'long':
                ...
                if execute_buy_order():
                    ...
                    trading_state.trade_history.append({
                        ...
                        'sol_amount': sol_balance,  # This will be updated after balance refresh
                ...
                if execute_sell_order():
                    ...
                    trading_state.trade_history.append({
                        ...
                        'sol_amount': sol_balance,  # Full balance sold
...
if __name__ == '__main__':
    print("\n" + "="*60)
    print("AUTOMATED SOL TRADING BOT - PERCENTAGE MODE")
    print("="*60)
    print("\nWARNING: This bot will execute REAL trades on your account!")
    print(f"Buy Strategy: {config.trade_percentage}% of USDT balance")
    print("Sell Strategy: ALWAYS 100% of SOL balance")
    print("Strategy: 2 out of 3 indicators must agree (Supertrend, MACD, FantailVMA)")
    print(f"Default Interval: {config.indicator_interval}")
    print(f"Default Check: {config.check_interval} seconds")
    print("\nCOINCATCH API REQUIREMENTS:")
    print("• Minimum Order: 0.1 SOL")
    print("• Minimum Notional Value: ~$15-20 USD")
